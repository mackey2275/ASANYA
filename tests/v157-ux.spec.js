...
const json=items=>JSON.stringify({schema_version:isV320?'3.2':isV310?'3.1':isV300?'3.0':isV250?'2.5':'1.5',...(isV310||isV300||isV250?{workspace_info_markdown:''}:{}),items,...(isV320?{snapshots:[]}:{})});
